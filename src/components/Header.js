          ...
          <Container>
            ...
            <Navbar.Collapse id="main_nav" className={isNavOpen ? 'show' : ''}>
              <Nav className="mr-auto">
                ...
                <NavDropdown title="About" id="about-us-dropdown" className="fw-bold">
                  <NavDropdown.Item as={Link} to="/about" className="fw-bold nav-item">About Us</NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/term-condition" className="fw-bold nav-item">Term & Condition</NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/privacy-policy" className="fw-bold">Privacy & Policy</NavDropdown.Item>
                </NavDropdown>
                ...
                <NavDropdown title="Pune ↔ Mumbai Cab" id="pune-mumbai-cab" className="fw-bold">
                  <NavDropdown.Item as={Link} to="/pune-mumbai-cabs" className="fw-bold nav-item">Pune ↔ Mumbai Cab</NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/Pune-to-Mumbai-Cab" className="fw-bold">Pune to Mumbai Cab</NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Mumbai ↔ Pune Cab" id="mumbai-pune-cab" className="fw-bold">
                  <NavDropdown.Item as={Link} to="/Mumbai-to-Pune-Daily-Cab" className="fw-bold">Mumbai to Pune Cab</NavDropdown.Item>
                </NavDropdown>
                ...
                <NavDropdown title="Contact" id="contact-dropdown" className="fw-bold">
                  <NavDropdown.Item as={Link} to="/contact" className="fw-bold nav-item">Contact</NavDropdown.Item>
                  <NavDropdown.Item as={Link} to="/enquiry" className="fw-bold">Enquiry</NavDropdown.Item>
                </NavDropdown>
              </Nav>
            </Navbar.Collapse>
          </Container>
